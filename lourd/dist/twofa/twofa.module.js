...
exports.TwofaModule = TwofaModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [twofa_service_1.TwofaService, prisma_service_1.PrismaService, config_1.ConfigService, jwt_1.JwtService, auth_service_1.AuthService, user_service_1.UserService],
    })
], TwofaModule);
