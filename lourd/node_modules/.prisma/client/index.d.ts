...
export namespace Prisma {
  ...
  */
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__AuthClient<T, Null = never, ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
  ...
  interface AuthFieldRefs {
    ...
    readonly expires: FieldRef<"Auth", 'DateTime'>
  }
   ...
   * Auth without action
   */
  export type AuthDefaultArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Auth
     */
    select?: AuthSelect<ExtArgs> | null
  ...
  export type AuthWhereInput = {
    ...
    expires?: DateTimeFilter<"Auth"> | Date | string
  }
  ...
  export type AuthScalarWhereWithAggregatesInput = {
    ...
    expires?: DateTimeWithAggregatesFilter<"Auth"> | Date | string
  }
   ...
   */
     ...
     */
    export type AuthArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = AuthDefaultArgs<ExtArgs>
